      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            {/* Process / Trust Card */}
            <div className="bg-[#FAF7F2] border border-[#D4A96A]/20 p-6 rounded-[2rem] space-y-4">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white border border-[#D4A96A]/15 rounded-[2.25rem] p-8 shadow-xl hover:shadow-2xl transition-all duration-300 space-y-6">
              <div>
