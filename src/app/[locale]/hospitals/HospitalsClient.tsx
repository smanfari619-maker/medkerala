  ...
  return (
    <div className="pt-32 pb-16 lg:pt-40 lg:pb-24 bg-[#FAF7F2] min-h-screen border-b border-[#D4A96A]/35">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-[#D4A96A]/15 rounded-[2.25rem] p-6 md:p-8 shadow-sm hover:shadow-md transition-all duration-300 mb-10 max-w-4xl mx-auto relative overflow-hidden">
        ...
        {filteredHospitals.length > 0 ? (
          ...
          /* Empty Search Result */
          <div className="text-center py-20 bg-white border border-[#D4A96A]/15 rounded-[2.25rem] max-w-2xl mx-auto space-y-6 shadow-sm px-6 mb-16 hover:border-[#2D6A4F]/25 transition-all duration-300">
